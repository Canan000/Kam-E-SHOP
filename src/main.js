...
// this update content catgegories
...
displayCategoryContent('category2', categoryContent);

categoryContent = '<h2>Enfants</h2> <p> hello this is content of category 3';

displayCategoryContent('category3', categoryContent);
